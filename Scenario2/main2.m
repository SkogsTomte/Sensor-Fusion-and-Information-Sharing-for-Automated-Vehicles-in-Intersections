%Main function: runs the scenario and plots the result
close all
clear all
plotOn = 0;
numberOfTests = 40;
...
[allData, scenario, sensor] = scenario2();
T = size(allData);
T = T(2);
...
[diffList1,diffList2,detected1,detected2]=stats(allData,[3,4,5,6,7],thingLists);
